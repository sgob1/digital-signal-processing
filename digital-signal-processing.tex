...
\begin{center}
    \begin{tikzpicture}
        ...
        \node[draw, polez] at (1.5, 0) {};
        \node[draw, zeroz] at (0, 0) {};
...
Generally speaking, \emph{causal} sequences will reflect a region of convergence \emph{outside} the unit circle, whilst \emph{anti-causal} sequences will possess a region of convergence \emph{inside} the unit circle.

A physical interpretation of the poles and zeros can be given by plotting the \emph{log-magnitude} of $G(z)$. The log-magnitude is the
