...
\subsection{Mimicking the linear operations}
...
\begin{align*}
    ...
    y[2] &= g_e[0]h_e[2] + g_e[1]h_e[1] + g_e[2] h_e[0] = 1 \times 1 + 2 \times 2 + 0 \times 2 = 5\\
    y[3] &= g_e[0]h_e[3] + g_e[1]h_e[2] + g_e[2] h_e[1] g_e[3]h_3[0] = 1 \times 1 + 2 \times 1 + 0 \times 2 + 1 \times 2 = 5\\
    y[4] &= g_e[1]h_e[3] + g_e[2]h_e[2] + g_e[3] h_e[1] = 2 \times 1 + 0 \times 2 + 1 \times 2 = 4\\
